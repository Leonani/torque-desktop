...
**ALWAYS generate a report after completing a code review.**
...
- **Ant Design Patterns**: [docs/skills/ant-design/SKILL.md](../ant-design/SKILL.md)
- **React 19 Patterns**: [docs/skills/react-19/SKILL.md](../react-19/SKILL.md)
- **TypeScript Patterns**: [docs/skills/typescript/SKILL.md](../typescript/SKILL.md)
