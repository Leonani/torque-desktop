...
description: >
  ...
  Trigger: Covers extracting functions, renaming variables, breaking down god functions, improving type safety, eliminating code smells, and applying design patterns. Less drastic than repo-rebuilder; use for gradual improvements.
license: MIT
metadata:
  author: Jose Limardo
  version: "1.0"
  scope: [root]
  auto_invoke: "Refactoring code"
---
