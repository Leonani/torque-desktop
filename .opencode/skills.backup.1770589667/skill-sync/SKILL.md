...
metadata:
  ...
  auto_invoke: "Writing React components/hooks in .jsx files (manual memoization, hooks dependencies, forwardRef, PropTypes)"
...
- Be specific about WHAT the user is doing (e.g., "Writing React 18 components" not just "Writing")
- Include context (e.g., "in .jsx files", "using antd", "with Tailwind")
